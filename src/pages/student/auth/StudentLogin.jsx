...
import { studentLoginAPI, clearAuthTokens } from "../../../utils/Api";
...
const StudentLogin = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      // Clear all tokens before setting the new one
      clearAuthTokens();
      ...
      if (response?.isAdmin) {
        ...
        localStorage.setItem("student", JSON.stringify(response.data)); // Save student data
      }
