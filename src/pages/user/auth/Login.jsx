          ...
          <div className="container-fluid page-body-wrapper full-page-wrapper">
            <div className="row w-100 m-0">
              ...
              >
                ...
                {/* Registration text and Notices box */}
                <div
                  style={{
                    position: "relative",
                    zIndex: 2,
                  ...
                  <div className="px-3 py-4 md:px-5 md:py-5">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                      ...
                      <div className="form-group d-flex align-items-center justify-content-between">
                        <NavLink
                          to="/forgot-pass"
                          className="forgot-pass text-white text-sm md:text-base"
                        >
                          Forgot password
                        </NavLink>
                      </div>
                      ...
                      <div className="mt-4 text-center text-white text-sm md:text-base">
                        <p className="sign-up">
                          ...
                          <NavLink to="/register" className="text-blue-300">
                            {" "}
                            Register
                          </NavLink>
                        </p>
  ...
  return (
    <div className="flex items-center justify-between bg-gray-800 py-2 px-4">
      <div className="flex flex-col md:flex-row items-center justify-between w-full md:w-[90%] mx-auto">
        <a
          href="https://agnelschooloflaw.com"
          target="_blank"
